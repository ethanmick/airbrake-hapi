...
(function() {
  ...
  Airbrake = (function(_super) {
    __extends(Airbrake, _super);
    ...
    Airbrake.prototype.notify = function(err, request) {
      var backtrace, error, json, message, stack, type, _ref;
      ...
      json = this.buildJSON({
        url: request != null ? (_ref = request.url) != null ? _ref.path : void 0 : void 0,
        error: {
          type: type,
          message: message,
          backtrace: backtrace
